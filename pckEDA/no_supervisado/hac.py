...
class HAC(Clustering):
    ...
    def plot_barras(self, titulo='Perfiles de Clusters — HAC',
        ...
        Args:
            titulo: Título del gráfico. Por defecto 'Perfiles de Clusters — HAC'.
    ...
    def plot_radar(self, titulo='Radar de Clusters — HAC'):
        ...
        Args:
            titulo: Título del gráfico. Por defecto 'Radar de Clusters — HAC'.
        """
